...
<div class="container mx-auto md:px-16">
	...
	>
		...
		<input
			...
			autocomplete="off"
			class="min-w-sm rounded-full border border-gray-300 px-6 py-4 text-center font-lora focus:border-transparent focus:ring-2 focus:ring-amber-800 focus:outline-none md:min-w-lg lg:min-w-4xl"
		/>
		<!-- <button
			type="submit"
