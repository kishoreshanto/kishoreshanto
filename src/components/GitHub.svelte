            ...
            <div class="mx-auto max-w-lg lg:mx-0 lg:w-0 lg:max-w-xl lg:flex-auto border-b-2 dark:border-sky-800 border-sky-300
                ...
                <div class="flex gap-4 align-middle items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="3rem"
                         preserveAspectRatio="true" font-size="3rem"
                ...
                <p class="ml-16 md:ml-16 font-bold text-gray-600 dark:text-gray-300">
                    {contribution}<br>
                    <span class="font-medium text-gray-400 mt-4 text-sm">
                            Contribution
                            <span class="text-green-600">{addition}</span> and
                            <span class="text-red-600">{subtraction}</span>
                        </span>
                </p>

                <div class="mt-4 ml-16 md:ml-16 flex gap-4">
                    <slot></slot>
                </div>
            </div>
        </div>
