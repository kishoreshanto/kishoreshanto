				...
				<div class="flex flex-row-reverse gap-6 justify-center lg:justify-end items-center">
					...
					<div class="relative flex-1 min-w-0">
						<input 
							...
							placeholder={isAskMode ? "AI mode, ask anything about me..." : "> "+ dynamicPlaceholder}
						...
						{#if isAskMode}
							...
							{:else}
								...
								<div class="absolute right-5 top-1/2 transform -translate-y-1/2 pointer-events-none flex items-center justify-center">
									<svg xmlns="http://www.w3.org/2000/svg" 
										 width="20" 
										 height="20" 
										 viewBox="0 0 24 24" 
						...
						{:else}
							...
							{:else}
								...
								<div class="absolute right-4 top-1/2 transform -translate-y-1/2 pointer-events-none flex items-center justify-center">
									<svg xmlns="http://www.w3.org/2000/svg" 
										 width="20" 
										 height="20" 
										 viewBox="0 0 24 24" 
					...
					<div class="ios-toggle-container">
						<button 
							...
							class="ios-toggle {isAskMode ? 'ai-mode' : 'search-mode'} {isTransitioning ? 'transitioning' : ''}"
