	...
	<div class="space-y-4">
		...
		<div class="flex items-center justify-between">
			...
			<div class="text-xs text-zinc-500 dark:text-zinc-400 font-mono">
				University Project Showcase 233
			</div>
		</div>

		<!-- Project Title and Tech Stack -->
		<div class="space-y-2">
			<h1 class="text-2xl font-bold text-sky-800 dark:text-zinc-100 leading-tight">Agri-Inn</h1>
			...
			<div class="flex items-start space-x-3 border-l-4 border-sky-300 pl-4 rounded-sm">
				<div>
					...
					<p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
						A comprehensive web application integrating farm management systems to connect customers
						directly with farm products, streamlining agricultural commerce and supply chain
						management.
					</p>
				</div>
			</div>
		...
		<div
			class="flex items-center justify-between bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-xl p-3 border border-orange-200 dark:border-orange-800"
		>
		...
		<!-- Key Innovation -->
		<div class="space-y-2">
			<p class="text-xs font-medium text-zinc-600 dark:text-zinc-400 uppercase tracking-wide">
		...
		<div class="space-y-2">
			...
			<div class="flex flex-wrap gap-2">
				...
				<span
					class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-300"
				>
					REST API
				</span>
				<span
				...
				<span
					class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-zinc-100 text-zinc-800 dark:bg-zinc-900/30 dark:text-zinc-300"
				>
					Vercel
				</span>
			</div>
		...
		<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
			<div class="space-y-2">
				<div>
					...
					<span class="text-zinc-600 dark:text-zinc-400">Team Leader & Lead Developer</span>
				</div>
				<div>
					<span class="font-medium text-zinc-700 dark:text-zinc-300">Award:</span>
					<span class="text-zinc-600 dark:text-zinc-400">2nd Runner Up (2nd Place)</span>
				</div>
				<div>
					<span class="font-medium text-zinc-700 dark:text-zinc-300">Duration:</span>
					<span class="text-zinc-600 dark:text-zinc-400">4 months</span>
				</div>
			</div>
