				...
				<div class="space-y-4">
					...
					<div class="flex items-center gap-3 mb-6 select-none">
						...
						<div class="flex flex-col gap-0.5">
							...
							<span
								class="text-xs font-semibold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"
							>
					...
					<div>
						...
						{:else}
							<div class="prose prose-gray dark:prose-invert max-w-none mt-4">
								<div class="text-gray-800 dark:text-gray-200 leading-relaxed text-left font-medium">
									{@html parsedAnswer}
								</div>
							</div>
						{/if}
