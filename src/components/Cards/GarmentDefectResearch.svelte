	...
	<div class="space-y-4">
		...
		<div class="space-y-2">
			<h1 class="text-2xl font-bold text-sky-800 dark:text-zinc-100 leading-tight">
				A Deep Learning based Approach for Automated Defect Detection of Fabrics in Garment
				Production Line
			</h1>
			...
			<div class="flex items-start space-x-3 border-l-4 border-sky-300 pl-4 rounded-sm">
				<div>
					...
					<p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
						Researched and implemented a deep learning solution for identifying and localizing
						defects in fabrics, using the YOLOv8.
					</p>
				</div>
			</div>
		</div>
		<div class="space-y-2">
			...
			<div class="flex flex-wrap gap-2">
				...
				<span class="research-tag"> YOLOv8 </span>
		...
		<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
			<div class="space-y-2">
				<div>
					...
					<p class="text-zinc-600 dark:text-zinc-400 font-mono text-xs">10.1145/3723178.3723196</p>
				</div>
				<div>
