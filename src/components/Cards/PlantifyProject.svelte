...
{#snippet cardContent()}
	<div class="space-y-4">
		...
		<div class="space-y-2">
			<h1 class="text-2xl font-bold text-sky-800 dark:text-zinc-100 leading-tight">Plantify</h1>
			...
			<div class="flex items-start space-x-3 border-l-4 border-sky-300 pl-4 rounded-sm">
				<div>
					...
					<p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
						A comprehensive plant information and management system featuring detailed species
						information, care guidelines, disease identification, user experience sharing, and plant
						identification capabilities with integrated gardening supply access.
					</p>
				</div>
			</div>
		</div>
