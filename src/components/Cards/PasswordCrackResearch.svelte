	...
	<div class="space-y-4">
		...
		<div class="space-y-2">
			<h1 class="text-2xl font-bold text-sky-800 dark:text-zinc-100 leading-tight">
				A Deep Learning Approach to Assess Password Strength, Compromise Likelihood, and
			...
			<div class="flex items-start space-x-3 border-l-4 border-sky-300 pl-4 rounded-sm">
				<div>
					...
					<p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
						Researched a GPT-2 based deep learning model for password strength estimation via
						sequence analysis and perplexity scoring on real-world leaked datasets
					</p>
				</div>
			</div>
		</div>
		...
		<div class="space-y-2">
			...
			<div class="flex flex-wrap gap-2">
				<span class="research-tag"> Generative Pretrained Transformer </span>
				<span class="research-tag"> Computer Security </span>
			</div>
		</div>
