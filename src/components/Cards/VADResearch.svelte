	...
	<div class="space-y-4">
			...
			<div class="flex items-start space-x-3 border-l-4 border-sky-300 pl-4 rounded-sm">
				<div>
					...
					<p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
						Researched a real-time anomaly detection system using Vision Transformers and an
						attention-enhanced network in long surveillance footage.
					</p>
				</div>
			</div>
		</div>
		...
		<div class="space-y-2">
			...
			<div class="flex flex-wrap gap-2">
				...
				<span class="research-tag"> Video Anomaly Detection </span>
				<span class="research-tag"> Vision Transformer </span>
				<span class="research-tag"> Simple Recurrent Unit Plus Plus (SRU++) </span>
				<span class="research-tag"> Spatio-Temporal Feature Analysis </span>
			</div>
		</div>
