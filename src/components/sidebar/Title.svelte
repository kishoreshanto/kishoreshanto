...
<script lang="ts">
    ...
    const items: string[] | undefined = data.titles;
</script>

{#if items}
    <h1 class="my-2 select-none xs:mt-0.5 flex flex-wrap font-display xs:text-2xl text-xl font-semibold dark:text-white text-black font-mono">
